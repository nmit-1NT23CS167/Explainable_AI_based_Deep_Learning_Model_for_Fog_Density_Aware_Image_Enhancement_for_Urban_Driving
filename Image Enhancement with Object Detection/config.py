"""
Unified Configuration — AOD-Net + GradCAM + YOLOv11 + SHAP
All latency-reduction switches are in the PERFORMANCE section.
"""

# ── Models ────────────────────────────────────────────────────────────────────
AOD_WEIGHTS       = "models/AOD_net_epoch_relu_10.pth"
YOLO_MODEL_SIZE   = "yolo11n.pt"        # nano=fastest; s/m/l/x for accuracy
